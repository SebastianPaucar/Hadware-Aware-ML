...
class _cyl_PtPz_mae_sebastian_loss(L1ADBaseLoss):
    def __init__(self, norm_scales, norm_biases, mask, unscale_energy = False, name="Cyl_PtPz_mae"):
        ...
        # Use constants for safety (no gradient issues)
        self.scales = tf.constant(self.scales, dtype=tf.float32)
        self.biases = tf.constant(self.biases, dtype=tf.float32)
